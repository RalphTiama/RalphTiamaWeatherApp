package com.example.sneakerups.screens
...
import com.example.ralphtiamaweatherapp.SignupScreenRoute
...
import com.example.ralphtiamaweatherapp.ui.theme.Purple80
...
fun LoginScreen(modifier: Modifier = Modifier, navController: NavHostController, authViewModel: AuthViewModel) {
    ...
    LaunchedEffect(authState.value) {
        when(authState.value){
            is AuthState.Authenticated -> navController.navigate(AuthenticatedRoute) {popUpTo<LoginScreenRoute>{inclusive = true} }
    ...
    Box(modifier = Modifier
        ...
        Column(
            ...
            Text(color = Color3, text = "Login", fontSize = 44.sp)
            ...
            TextButton(onClick = {
                ...
                Text(text = "Don't have an account, Signup", color = Color7)
            }
